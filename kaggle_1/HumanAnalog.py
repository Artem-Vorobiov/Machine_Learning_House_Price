...
#  Выбирает ряд индивидуально и и исправляет его.
...
print('\n\n\n')
# print(test_df[['GarageQual', 'GarageCond', 'GarageFinish', 'GarageYrBlt']])
# print(test_df.loc[666, ['GarageQual', 'GarageCond', 'GarageFinish', 'GarageYrBlt']])


# The test example 1116 only has GarageType but no other information. We'll 
# assume it does not have a garage.
# print(test_df.loc[1116])
...
# print(lot_frontage_by_neighborhood.groups)
...
label_df["SalePrice"] = train_df["SalePrice"].values
...
# zzz = pd.DataFrame(regr.predict(test_df_munged))
...
# with open('../data/AnalogXGB_1.csv', 'w') as f:
...
pred_df.to_csv('../data/AnalogLasso.csv', header=True, index_label='Id')
